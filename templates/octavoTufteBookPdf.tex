...
%
\documentclass[$if(fontsize)$$fontsize$,$endif$$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$paper,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{tufte-book}
...
\newtcolorbox{highlight}{textmarker,colback=base02,colframe=yellow,colupper=base1}
\newtcolorbox{task}{textmarker,colback=base02,colframe=red,colupper=base1}
\newtcolorbox{journal}{textmarker,colback=base02,colframe=blue,colupper=base1} 

\newtcbox{\boxexturl}{fontupper=\ttfamily,enhanced,nobeforeafter,tcbox raise base,boxrule=0.4pt,top=0mm,bottom=0mm,
  right=0mm,left=4mm,arc=1pt,boxsep=2pt,before upper={\vphantom{dlg}},
  colframe=blue,coltext=base1,colback=base02,
  overlay={\begin{tcbclipinterior}\fill[blue] (frame.south west)
    rectangle node[text=base2,font=\sffamily\bfseries\tiny,rotate=90] {GO} ([xshift=4mm]frame.north west);\end{tcbclipinterior}}}
    
\newtcbox{\boxinturl}{fontupper=\ttfamily,enhanced,nobeforeafter,tcbox raise base,boxrule=0.4pt,top=0mm,bottom=0mm,
  right=0mm,left=4mm,arc=1pt,boxsep=2pt,before upper={\vphantom{dlg}},
  colframe=red,coltext=base1,colback=base02,
  overlay={\begin{tcbclipinterior}\fill[red] (frame.south west)
    rectangle node[text=base2,font=\sffamily\bfseries\tiny,rotate=90] {GO} ([xshift=4mm]frame.north west);\end{tcbclipinterior}}}
    

% Set up 'answer boxes'
\tcbset{answerbox/.style={enhanced jigsaw, breakable,title=Answer box, coltitle=base2, colback=base02, colbacktitle=base01, colframe=base02,colupper=base1,collower=base1}}
\newtcolorbox{answer}{answerbox}

% My own versions
\DeclareTotalTCBox{\inlineKeyword}{ O{violet} v O{} }
{ fontupper=\ttfamily,nobeforeafter,tcbox raise base,arc=0pt,outer arc=0pt,
  top=0pt,bottom=0pt,left=0mm,right=0mm,
  leftrule=0pt,rightrule=0pt,toprule=0.2mm,bottomrule=0.2mm,boxsep=0.9mm,
  colback=magenta!50!base03,colframe=magenta,colupper=base2,#3}{#2}

\DeclareTotalTCBox{\inlinePopout}{ O{violet} v O{} }
{ fontupper=\ttfamily,nobeforeafter,tcbox raise base,arc=0pt,outer arc=0pt,
  top=0pt,bottom=0pt,left=0mm,right=0mm,
  leftrule=0pt,rightrule=0pt,toprule=0.2mm,bottomrule=0.2mm,boxsep=0.9mm,
  colback=red!50!base03,colframe=red,colupper=base2,#3}{#2}

\DeclareTotalTCBox{\inlineDo}{ O{colourRich} v O{} }
{ fontupper=\ttfamily,nobeforeafter,tcbox raise base,arc=2pt,outer arc=2pt,
  top=0pt,bottom=0pt,left=0mm,right=0mm,
  leftrule=0.2mm,rightrule=0.2mm,toprule=0.2mm,bottomrule=0.2mm,boxsep=0.9mm,
  coltext=white,colback=colourRich,colframe=colourRich,#3}{#2}
